...
import { AppRouteRecordRaw } from '@/core/router/types';
import { useMultipleTabStore } from '@/core/stores/modules/multipleTab';
import { useMultipleTabSetting } from '@/core/hooks/setting/useMultipleTabSetting';
